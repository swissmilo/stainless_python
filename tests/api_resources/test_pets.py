...
class TestPets:
    ...
    @parametrize
    def test_method_retrieve(self, client: MiloJan22) -> None:
    ...
    @parametrize
    def test_raw_response_retrieve(self, client: MiloJan22) -> None:
    ...
    @parametrize
    def test_streaming_response_retrieve(self, client: MiloJan22) -> None:
    ...
    @parametrize
    def test_path_params_retrieve(self, client: MiloJan22) -> None:
...
class TestAsyncPets:
    ...
    @parametrize
    async def test_method_retrieve(self, async_client: AsyncMiloJan22) -> None:
    ...
    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncMiloJan22) -> None:
    ...
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncMiloJan22) -> None:
    ...
    @parametrize
    async def test_path_params_retrieve(self, async_client: AsyncMiloJan22) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pet_id` but received ''"):
