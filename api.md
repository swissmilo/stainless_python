...
- <code title="get /pets/{petId}">client.pets.<a href="./src/milo_jan_22/resources/pets.py">retrievewithmeagainnot</a>(pet_id) -> <a href="./src/milo_jan_22/types/pet.py">Pet</a></code>
